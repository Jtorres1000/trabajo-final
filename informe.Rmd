...
\textbf{1.}	¿Cómo ha evolucionado el promedio de duración de las canciones a nivel global entre 2015 y 2025, y existe evidencia de una reducción de la misma año tras años?
...
\begin{itemize}
  \item{Determinar la influencia del formato de video corto y vertical en la evolución de la duración estructural de las canciones producidas por la industria musical global durante la última década}
...
\subsection{Horizontal}
 \item{stigación abarca la totalidad de los registros válidos en el dataset (85,000 pistas), incluyendo todos los géneros musicales y los 10 países representados en la muestra (USA, UK, Brazil, India, Australia, France, Germany, Japan, Canada, Mexico*). *Nota: Se asumen los países visibles en tu gráfico previo}

\subsection{vertical}
 \item{udio se delimita al análisis de las características técnicas de audio (tiempo, ritmo, energía) y su distribución temporal y geográfica, excluyendo análisis de contenido lírico o armónico complejo}
