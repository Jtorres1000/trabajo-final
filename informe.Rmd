...
El mercado musical global está fragmentado. Lo que es un éxito en Brasil puede no serlo en Alemania. Además, se desconoce si ciertos sellos discográficos
...
\begin{itemize}
  \item{Mapear la distribución geográfica de los géneros musicales y la influencia de las disqueras en los diferentes mercados.}
\end{itemize}
